...
const nav_menu=[
    ...
    {label:"Home",function:"navigate({fn:'show_home'})"roles:["owner","administrator","employee", "user"]},
...
async function checked_in_toys(id){
    tag("canvas").innerHTML= `
    <div class="page">

    <h2> Checked in Toys </h2>
    <div id="toy_list_panel">
    <i class="fas fa-spinner fa-pulse"></i>
    </div>
    </div>
    ...
    const update_response = await server_request({mode:"update_checkedin",id:id})
